...
createmon(struct wl_listener *listener, void *data)
{
	...
	for (r = monrules; r < END(monrules); r++) {
		...
		// Completely broken code, rely on autostart for Hz

			wlr_output_state_set_custom_mode(&state, r->resx, r->resy, r->rate);
			printf("resx: %i, resy: %i, rate: %f\n", r->resx, r->resy, r->rate);
			/*
